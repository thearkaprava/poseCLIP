...
class BaseDataset(Dataset, metaclass=ABCMeta):
    def __init__(self,
        ...
        ## Loading Hyperformer Data
        if 'ntu' in self.ann_file:
            # data: N C V T M
            data_path = '/data/ntu/Hyperformer_processed_data/NTU60_CS.npz'  #NTU60_CVS1.npz' 
    ...
    def load_annotations(self):
        ...
        with open(self.ann_file, 'r') as fin:
            for line in fin:
                ...
                ### Comment out during Async Training
